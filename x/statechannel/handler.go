...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgWithdrawCoin:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgSendCoinHashlock:
			res, err := msgServer.SendCoinHashlock(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgWithdrawCoinHashlock:
			res, err := msgServer.WithdrawCoinHashlock(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
